  ...
  >
    ...
    <div class="flex flex-1 items-center justify-end">
      ...
      >
        <a
          href="/about"
          class="block h-16 border-b-4 border-transparent leading-[4rem] hover:border-current hover:text-custom-purple-light"
        >
          News
        </a>
      ...
      <div class="ml-8 flex items-center">
        ...
        >
          ...
          <span>
            <a
              href="/account"
              class="block border-b-4 border-transparent p-6 hover:border-custom-purple-light"
            >
              <svg
                class="h-4 w-4"
                xmlns="http://www.w3.org/2000/svg"
